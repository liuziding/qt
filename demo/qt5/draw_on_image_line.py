...
class GraphicsView(QtWidgets.QGraphicsView):
    def __init__(self, parent=None):
        ...
        self._line_item = QtWidgets.QGraphicsLineItem(self.pixmap_item)
        self.line_item.setPen(QtGui.QPen(QtCore.Qt.black, 5, QtCore.Qt.SolidLine))
        self.line_item.setBrush(QtGui.QBrush(QtCore.Qt.red, QtCore.Qt.VerPattern))
    ...
    def mousePressEvent(self, event):
        ...
        line = self.line_item.polygon()
        poly.append(lp)
        self.line_item.setPolygon(poly)
