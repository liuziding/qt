...
from PySide6.QtWidgets import (QApplication, QGraphicsView, QGridLayout, QGroupBox,QGraphicsScene,QGraphicsVideoItem,
...
class jaabaGUI(QMainWindow):
	...
	def __init__(self,parent=None):
		self.debugMode = True
		self.debugVideoPath = "E:\\haitong\\VehicleTracking\\code\\demo\\day\\day-409-3-0000_0030.mp4"
		...
		#setup Video
		#video player
		self.mediaPlayer1 = QMediaPlayer(None)
		self.mediaPlayer2 = QMediaPlayer(None)
